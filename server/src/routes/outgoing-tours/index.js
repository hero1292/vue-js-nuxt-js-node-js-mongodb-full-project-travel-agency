...
router.post('/outgoing-tours', upload.fields([{
  name: 'files[]',
  maxCount: 15
}]), (req, res) => {
  tour.create({
...
router.get('/:lang/outgoing-tours', (req, res) => {
  tour.find({}, (err, tours) => {
    if (err) {
...
router.get('/:lang/outgoing-tours/:id', (req, res) => {
...
router.get('/outgoing-tours/:id', (req, res) => {
  tour.findById(req.params.id, 'title ' +
    'country ' +
    'days ' +
    'nights ' +
...
router.put('/outgoing-tours/:id', (req, res) => {
...
router.delete('/:lang/outgoing-tours/:id', (req, res) => {
